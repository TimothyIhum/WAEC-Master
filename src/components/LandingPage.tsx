...
export default function LandingPage({
  ...
  return (
    ...
    >
      ...
      <header
        id="landing-header"
        className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 py-3 px-6"
      >
      ...
      <section
        id="landing-hero"
        className="relative py-16 px-6 overflow-hidden bg-gradient-to-b from-indigo-50/70 via-white to-slate-50"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-100 text-indigo-800 text-xs font-semibold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5 animate-pulse" /> #1 CBT Exam
              Prep Platform in West Africa
            </div>
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl text-slate-950 leading-tight tracking-tight">
              ...
              <span className="text-indigo-600 bg-gradient-to-r from-indigo-600 via-indigo-500 to-violet-600 bg-clip-text text-transparent">
                Earn Straight A1s.
              </span>
            </h1>

            <p className="text-slate-600 text-lg max-w-xl leading-relaxed">
              Ditch the boring past question paper booklets! Challenge your
              classmates in rapid quiz battles, climb national leaderboards, and
              get instant calculus help from our expert AI Tutor.
            </p>
            ...
            <div className="relative bg-white rounded-3xl border border-slate-100 shadow-2xl p-6 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Create an account to save streaks, XP and rankings
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-slate-50 p-3 rounded-2xl text-center">
                  <p className="text-slate-400 text-2xs font-bold uppercase tracking-wider">
                    Streak
                  </p>
                  <p className="text-xl font-extrabold text-slate-600 flex items-center justify-center gap-0.5 mt-0.5">
                    <Flame className="w-4.5 h-4.5" /> 0
                  </p>
                </div>
                <div className="bg-slate-50 p-3 rounded-2xl text-center">
                  <p className="text-slate-400 text-2xs font-bold uppercase tracking-wider">
              ...
              <div className="bg-violet-50 border border-violet-100/50 rounded-2xl p-4 flex gap-3 text-sm text-violet-950">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">
                    Practice daily to build your streak and unlock smarter
                    recommendations.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-slate-600">
            Every screen, sound, and notification of WAEC Master is developed to
            keep students actively engaged and motivated.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <h3 className="font-display font-bold text-xl text-slate-900">
              Authentic WAEC Syllabus
            </h3>
            <p className="text-slate-600 text-sm leading-relaxed">
              Real questions with calculations, maps, diagrams, detailed
              feedback, and hints. Mathematics, Chemistry, English and 12 more
              subjects.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Compete live with school peers and random candidates. Answer
              accurately in real-time, send emojis, and win trophy bonuses!
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Stuck on a complex chemical formula or a government essay
              question? Get step-by-step, simple guidance instantly.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Level up, build active daily streaks, complete daily study
              missions, spin the reward wheel, and earn gold medals!
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Download test modules in advance! Practice with no data bundle or
              when network services are sparse/intermittent.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition duration-300 space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              View your performance heatmap, average completion velocity, list
              of weak topics, and see overall progress trends over time.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-slate-950">
              A1 Stories From Top Candidates
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-3xl border border-slate-100 relative space-y-4 shadow-sm">
              ...
              <p className="text-slate-600 text-sm italic">
                "WAEC Master transformed my preparation! The multiplayer battles
                made study addictive. I scored 8 A1s in my exams, including and
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 relative space-y-4 shadow-sm">
              ...
              <p className="text-slate-600 text-sm italic">
                "The step-by-step math solver is a lifesaver. It showed me
                precisely where my calculations failed. Highly recommend to all
                SSS candidates."
              </p>
              <div>
                <h4 className="font-bold text-slate-900 text-sm">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 relative space-y-4 shadow-sm">
              ...
              <p className="text-slate-600 text-sm italic">
                "The offline mode allowed me to practice at the workspace in
                Freetown where data connection is slow. Truly made my WAEC prep
                smooth."
              </p>
              <div>
                <h4 className="font-bold text-slate-900 text-sm">
      ...
      >
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-600">
            Start for free and unlock the ultimate toolkit when you are ready to
            dominate.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 space-y-6 relative hover:border-slate-300">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Essential prep for daily revision
              </p>
            </div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 list-none p-0">
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-500" /> Basic
                Subject Practice
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-500" /> Global
                Leaderboard access
              </li>
              <li className="flex items-center gap-2 font-light text-slate-400">
                <Lock className="w-3.5 h-3.5" /> Unlimited AI explanations
              </li>
              <li className="flex items-center gap-2 font-light text-slate-400">
                <Lock className="w-3.5 h-3.5" /> High Stakes tournament rooms
              </li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 p-8 rounded-3xl border-2 border-indigo-500 space-y-6 relative text-white shadow-xl shadow-indigo-950/20 transform md:-translate-y-2">
            <span className="absolute top-4 right-4 bg-indigo-500 text-white text-3xs font-black uppercase tracking-widest px-2.5 py-1 rounded-full">
              POPULAR
            </span>
            <div>
              <h3 className="font-bold text-lg">Premium Master VIP</h3>
              <p className="text-xs text-slate-400">
                Complete prep for Straight A1 candidates
              </p>
            </div>
            ...
            <ul className="space-y-3 text-sm text-slate-300 list-none p-0">
              ...
              <li className="flex items-center gap-2 text-white font-semibold">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-400" /> Premium
                simulated WAEC & JAMB Mocks
              </li>
              <li className="flex items-center gap-2 text-white font-semibold">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-400" />{" "}
                Auto-generated revision briefs
              </li>
              <li className="flex items-center gap-2 text-white font-semibold">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-400" /> VIP
                Rank progression and double XP
              </li>
              <li className="flex items-center gap-2 text-white font-semibold">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-400" /> Unlock
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 space-y-6 relative hover:border-slate-300">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Track, monitor and reward your child
              </p>
            </div>
            <div className="flex items-baseline text-slate-900">
              <span className="text-4xl font-extrabold tracking-tight">
            ...
            <ul className="space-y-3 text-sm text-slate-600 list-none p-0">
              <li className="flex items-center gap-2">
                ...
                Real-time activity emails/SMS
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-500" /> Study
                hour locking features
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-500" /> Custom
                rewards & medals allocation
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4.5 h-4.5 text-emerald-500" /> SSS
      ...
      <section id="landing-faq" className="bg-slate-100 py-20 px-6">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-600">
              Everything you need to know about preparing for WAEC exams on WAEC
              Master.
            </p>
          </div>
            ...
            {FAQS.map((faq, idx) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-slate-400 transition transform ${faqOpen[idx] ? "rotate-180" : ""}`}
                  />
                </button>
                {faqOpen[idx] && (
      ...
      <footer
        id="landing-footer"
        className="bg-slate-950 text-slate-400 py-12 px-6 border-t border-slate-900 text-center"
      >
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="flex items-center justify-center gap-2">
            <span className="p-1.5 bg-indigo-600 rounded-lg text-white font-bold">
          ...
          <p className="text-xs max-w-sm mx-auto">
            Providing high impact CBT training across Nigeria, Ghana, Sierra
            Leone, Gambia, and Liberia. Empowering scholars to fulfill their
            professional limits.
          </p>
          <div className="text-3xs text-slate-600">
            © 2026 WAEC Master, Inc. All rights reserved. This web application
            is an educational preparation resource.
          </div>
        </div>
      </footer>
    </div>

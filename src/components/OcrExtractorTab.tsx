...
export default function OcrExtractorTab({
  ...
  const approveAndCommitQuestion = (ocrQ: ParsedOcrQuestion) => {
    const formatted: Question = {
      id: `past-q-${ocrSubjectHint.toLowerCase().substr(0,3)}-${Date.now()}-${Math.floor(Math.random() * 1000)}`,
      subject: ocrSubjectHint,
      examYear: Number(ocrYearHint),
                      ...
                      >
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2.5 pb-2 border-b border-dashed border-slate-200/70 text-[10px]">
                          <div className="flex items-center gap-2.5">
                            ...
                            <span className="bg-slate-200 text-slate-600 font-black px-2 py-0.5 rounded-sm uppercase tracking-wider text-[8px]">
                        ...
                        {isEditing ? (
                          <div className="space-y-3 pt-1 animate-fadeIn">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                              ...
                              <div className="space-y-1">
                                <label className="font-extrabold text-slate-500 uppercase text-[9px]">Syllabus sub-Topic Label</label>
                                <input
                                  type="text"
                                  value={ocrQ.topic}
